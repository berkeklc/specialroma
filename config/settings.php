...
return [
     ...
     */
    'settings' => [
        Modules\Core\App\Settings\GeneralSettings::class,
        Modules\Core\App\Settings\SeoSettings::class,
        Modules\Core\App\Settings\MailSettings::class,
    ],
...
//        Spatie\DataTransferObject\DataTransferObject::class => Spatie\LaravelSettings\SettingsCasts\DtoCast::class,
    ...
    'auto_discover_settings' => [
        app_path('Settings'),
        base_path('Modules/Core/app/Settings'),
    ],
